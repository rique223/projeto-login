    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "input svelte-1cklpjl");
    			attr_dev(input0, "placeholder", " ");
    			add_location(input0, file, 165, 12, 3223);
    			attr_dev(label0, "for", "email");
    			attr_dev(label0, "class", "label svelte-1cklpjl");
    			add_location(label0, file, 166, 12, 3301);
    			attr_dev(div0, "class", "field svelte-1cklpjl");
    			add_location(div0, file, 164, 8, 3191);
    			attr_dev(input1, "type", input1_type_value = /*showPassword*/ ctx[2] ? "text" : "password");
    			attr_dev(input1, "class", "input svelte-1cklpjl");
    			attr_dev(input1, "placeholder", " ");
    			add_location(input1, file, 170, 12, 3405);
    			attr_dev(label1, "for", "password");
    			attr_dev(label1, "class", "label svelte-1cklpjl");
    			add_location(label1, file, 171, 12, 3527);
    			attr_dev(span0, "class", "toggle-password svelte-1cklpjl");
    			add_location(span0, file, 173, 12, 3590);
    			attr_dev(div1, "class", "field svelte-1cklpjl");
    			add_location(div1, file, 169, 8, 3373);
    			attr_dev(span1, "class", "bar bar-1 svelte-1cklpjl");
    			toggle_class(span1, "bar-show", /*strength*/ ctx[0] > 0);
    			add_location(span1, file, 182, 12, 3884);
    			attr_dev(span2, "class", "bar bar-2 svelte-1cklpjl");
    			toggle_class(span2, "bar-show", /*strength*/ ctx[0] > 1);
    			add_location(span2, file, 183, 12, 3953);
    			attr_dev(span3, "class", "bar bar-3 svelte-1cklpjl");
    			toggle_class(span3, "bar-show", /*strength*/ ctx[0] > 2);
    			add_location(span3, file, 184, 12, 4021);
    			attr_dev(span4, "class", "bar bar-4 svelte-1cklpjl");
    			toggle_class(span4, "bar-show", /*strength*/ ctx[0] > 3);
    			add_location(span4, file, 185, 12, 4089);
    			attr_dev(div2, "class", "strength svelte-1cklpjl");
    			add_location(div2, file, 181, 8, 3849);
    			add_location(li0, file, 189, 12, 4211);
    			add_location(li1, file, 190, 12, 4294);
    			add_location(li2, file, 191, 12, 4378);
    			add_location(li3, file, 192, 12, 4452);
    			set_style(ul, "text-align", "left");
    			add_location(ul, file, 188, 8, 4169);
    			attr_dev(button, "class", "bot svelte-1cklpjl");
    			add_location(button, file, 195, 8, 4565);
    			attr_dev(form, "class", "svelte-1cklpjl");
    			add_location(form, file, 162, 4, 3175);
    			add_location(main, file, 161, 0, 3164);
    		},
